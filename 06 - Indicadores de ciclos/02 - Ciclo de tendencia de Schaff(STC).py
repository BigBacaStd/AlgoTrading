...
def Ciclo_Tendencia_Schaff(df: pd.DataFrame, longitud_rapida: int =23, longitud_lenta: int = 50, ciclo: int = 10, suavizado: int = 3,
    ...
    """
        ...
        Cómo Operarlo:
            ...
            pueden usarse como áreas de sobre compra y sobreventa.
...
# Rellenar áreas de sobre compra en verde

for fecha_inicio in stc[stc >= 75].index:
    # Encontrar la fecha final para el área de sobre compra que se quiere colorear
    fecha_final = (
...
# Rellenar áreas de sobre compra en rojo

for fecha_inicio in stc[stc <= 25].index:
    # Encontrar la fecha final para el área de sobre venta que se quiere colorear
    fecha_final = (
...
#   - Los niveles de 25 y 75 actúan como zonas de sobre compra y sobreventa, respectivamente.
