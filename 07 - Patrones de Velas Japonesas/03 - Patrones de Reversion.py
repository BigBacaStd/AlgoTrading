...
if len(df_morning_star) > 0:
    fig, axes = mpf.plot(df_morning_star, type="candle", style="yahoo", volume=True, figsize=(22, 10), titile="Patrón Morning Star",
                         ylabel="Precio", ylabel_lower="Volumen", panel_ratios=(2, 1), returning=True)
    plt.show()

# Patrón Evening Star: El Evening Star es un patrón bajist de tres velas que señala un cambio en la tendencia de alcista a bajista.
