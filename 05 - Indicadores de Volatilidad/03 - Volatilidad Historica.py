...
# Descargar datos
ticker = "BTC-USD"
df = yf.download(ticker, start="2022-01-01", end="2025-10-29", multi_level_index=False)
...
ax.axhspan(umbral_2, volatilidad_historica.max(), color="red", alpha=0.3,
           label="Más de 3 Desviación Estándar arriba del promedio")
