...
# Indicador: Indice de Volatilidad Relativa
def Indice_Volatilidad_Relativa(df: pd.DataFrame, longitud_std_dev: int = 14, longitud_suavizado: int = 14,
...
ticker = "BTC-USD"
df = yf.download(ticker, start="2024-01-01", end="2025-10-30", interval="1d", multi_level_index=False)

# Calcular el Indice de Volatilidad Relativa
...
axes[0].set_title("Indice de Volatilidad Relativa de: " + ticker, fontsize=16, weight="bold")
