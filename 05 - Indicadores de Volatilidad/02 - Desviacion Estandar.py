...
# Descargar datos historicos para diferentes activos
tickers = ["AAPL", "MSFT", "GOOGL", "TSLA", "NFLX", "NVDA", "PYPL", "BTC-USD"]
start_date = "2023-01-01"
end_date = "2025-10-28"

# Crear un diccionario vacío para almacenar datos
...
# Calcular los retornos y las volatilidades de cada activo
...
barras = ax.bar(resultados.index, resultados["Volatilidad Anual"], color=["blue", "green", "red", "gray", "orange", "purple",
                                                                 "yellow", "pink", "salmon"])
...
ax.set_xlabel("Acciones/Instrumentos", fontsize=14)
ax.set_ylabel("Volatilidad Anual de los Rendimientos", fontsize=14)
ax.set_title("Comparación de la Desviación Estandar de los Precios con Retornos Anuales", fontsize=16, weight="bold")
ax.grid()
...
# Recordatorio:
#   - La desviación estándar de los rendimientos mide la volatilidad de un activo, indicando como varían sus rendimientos.
#   - respecto a su promedio. Una alta desviación significa mayor riesgo e incertidumbre.
#   - En la gestíon de riesgo, controlar la desviación estándar ayuda a evaluar la estabilidad de un activo y ajustar
#   - las estrategias de inversion para minimizar las perdidas y optimizar el rendimiento.
