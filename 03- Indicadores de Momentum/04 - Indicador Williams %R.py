...
def Williams_PerR(df: pd.DataFrame, longitud: int = 14) -> pd.Series:
    ...
    """
    Williams %R, tambien conocido como el Rango Porcentual de Williams, es un tipo de indicador de momentum que se mueve entre 0 y -100
    y mide los niveles de sobrecompra y sobreventa. Una lectura de -20 se considera sobrecompra y una lectura por debajo
    ...
    simplemente significa que el precio está cerca del máximo de su rango reciente y sobreventa significa que el precio está en el
...
plt.axhline(y=-80, color="red", linestyle="--", label="SobreVenta (-80)")
...
#   -Las lineas discontinuas en rojo y verde representan los niveles criticos de sobrecompra y sobreventa, respectivamente.
